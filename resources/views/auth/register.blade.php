                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="woonplaats" type="text" class="form-control @error('woonplaats') is-invalid @enderror" name="woonplaats" value="{{ old('woonplaats') }}" required autocomplete="woonplaats">
